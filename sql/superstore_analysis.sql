...
Insight Final:
Temuan 1 — Korelasi Terbukti: Data membuktikan korelasi negatif yang kuat antara discount dan profit margin — semakin besar discount yang diberikan, semakin kecil profit margin yang dihasilkan bahkan berubah menjadi negatif.
...
Rekomendasi:
•	Jangka pendek: Terapkan kebijakan batas maksimal diskon 20% secara ketat di region Central — region ini adalah prioritas utama karena avg discount-nya sudah melewati threshold kritis
...
Rekomendasi:
•	Jangka pendek: Terapkan batas maksimal diskon 20% untuk Bookcases dan Tables — potential recovery gabungan mencapai 41,153.96 jika kebijakan ini dijalankan konsisten
...
BQx #7 — POTENSI NILAI TAMBAH JIKA REGION UNDER-PERFORM MENCAPAI RATA-RATA PROFIT MARGIN NASIONAL
...
Jika Central dan South berhasil mencapai rata-rata profit margin nasional (12.47%), total potential gain yang bisa diraih adalah 24,896.54 — setara dengan peningkatan profit sebesar 26.64% dari total profit aktual tahun 2017 sebesar 93,439.27.
Koneksi dengan BQ Sebelumnya:
